...
impl From<SetupHandoffState> for SetupHandoffReport {
    fn from(state: SetupHandoffState) -> Self {
        Self {
            ...
            selected_lane_id: state.selected_lane_id,
            selected_lane_label: state.selected_lane_label,
            selected_lane_kind: state.selected_lane_kind,
            selected_backend_id: state.selected_backend_id,
            selected_lane_detail: state.selected_lane_detail,
            selected_lane_compatibility_note: state.selected_lane_compatibility_note,
            selected_access_mode: state.selected_access_mode,
            selected_primary_model: state.selected_primary_model,
            selected_primary_model_source: state.selected_primary_model_source,
