...
fn test_model_constants() {
    ...
    assert_eq!(EmbeddingModel::EmbedEnglishV3.as_str(), "embed-english-v3.0");
    assert_eq!(EmbeddingModel::EmbedMultilingualV3.as_str(), "embed-multilingual-v3.0");
}
...
fn test_finish_reason() {
    ...
    assert_ne!(std::mem::discriminant(&complete), std::mem::discriminant(&max_tokens));
}

#[test]
fn test_constants() {
    use cohere::{DEFAULT_BASE_URL, DEFAULT_API_VERSION};
