//! Chat completions API for Fireworks AI.
...
pub struct ChatRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub seed: Option<i64>,
    /// Context length for the model (Fireworks-specific).
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct ChatRequestBuilder {
    ...
    seed: Option<i64>,
    context_length_exceeded_behavior: Option<String>,
}
...
impl ChatRequestBuilder {
    ...
    /// Add a tool message.
    pub fn tool_message(mut self, tool_call_id: impl Into<String>, content: impl Into<String>) -> Self {
    ...
    /// Set context length exceeded behavior (Fireworks-specific).
    /// Options: "truncate", "error"
    pub fn context_length_exceeded_behavior(mut self, behavior: impl Into<String>) -> Self {
        self.context_length_exceeded_behavior = Some(behavior.into());
        self
    }
    ...
    pub fn build(self) -> ChatRequest {
        ChatRequest {
            ...
            seed: self.seed,
            context_length_exceeded_behavior: self.context_length_exceeded_behavior,
        }
    }
}
