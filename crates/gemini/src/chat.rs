...
use crate::{GeminiClient, Content, GenerateContentRequest, GenerateContentResponse, GeminiError, GenerationConfig, Part};
...
impl<'a> ChatSession<'a> {
    ...
    pub async fn send_message(&mut self, message: impl Into<String>) -> Result<String, GeminiError> {
    ...
    pub async fn send_message_full(&mut self, message: impl Into<String>) -> Result<GenerateContentResponse, GeminiError> {
        let message_text: String = message.into();
        let user_content = Content::user(&message_text);
