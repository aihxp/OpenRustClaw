...
impl GeminiClient {
    ...
    pub async fn generate_content(
        ...
        self.generate_content_with_model(self.default_model.clone(), request)
            .await
    }
    ...
    pub async fn stream_generate_content(
        ...
        impl futures::Stream<Item = Result<GenerateContentResponse, GeminiError>>,
        GeminiError,
    > {
...
mod tests {
    ...
    fn test_client_with_model() {
        let client = GeminiClient::new("test-api-key").with_model(GeminiModel::Gemini15Flash);
