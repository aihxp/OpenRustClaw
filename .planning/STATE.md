...
- v1.12 reopens the remote-connectivity story so nodes, advanced remote access, and SSH tunnel usage become an explicit product contract instead of an onboarding footnote, with node-first behavior and SSH tunnel fallback.
