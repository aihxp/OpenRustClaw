...
## Most Recent Milestone: v1.43 Learning Loop, Memory Depth, and God Mode
...
**Archive:** `.planning/milestones/v1.43-ROADMAP.md`, `.planning/milestones/v1.43-REQUIREMENTS.md`, `.planning/milestones/v1.43-MILESTONE-AUDIT.md`, `.planning/milestones/v1.43-VERIFICATIONS.md`

## Current Milestone: v1.44 Agent Discovery, Journey Cohesion, and Provider Access

**Goal:** Make OpenRustClaw's agent experience feel coherent from install through execution by unifying local agent discovery, compliance-safe delegated backend access, truthful onboarding, and end-to-end journey repair.

**Target features:**
- Detect installed local agent tools and expose truthful capability, auth, and policy metadata
- Support subscription-managed and account-managed vendor surfaces only through documented or supported execution paths
- Converge onboarding, model selection, inspect, and control around one canonical provider or agent catalog
- Route eligible work through delegated local agent backends with audit evidence and bounded autonomy controls
- Audit the full user journey and agent journey, then repair disconnected surfaces, terminology, and dead ends
...
- ✓ Onboarding now captures a truthful provider-access-model lane end to end, including live verification, explicit primary-model selection, persisted handoff evidence, and first-launch continuity — v1.42 Phases 177-180
...
The next follow-on queue returned to onboarding behavior rather than broad repo cleanup. `v1.42` captured provider access mode, live verification evidence, explicit primary-model selection, and provider-model continuity through handoff, repair, resume, and first launch without broadening into a generic provider-management redesign.
...
- there is an active milestone: `v1.44 Agent Discovery, Journey Cohesion, and Provider Access`
