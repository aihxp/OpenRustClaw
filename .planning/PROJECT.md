...
**Goal:** No active milestone. The completed historical greenfield ledger (`18/18`), adapter-only full-conversion roadmap (`6/6`), native-delivery planning roadmap (`8/8`), and the first four implementation slices (`4/6`) now define the current canonical progress baselines.
...
- None. The next follow-on work should continue through the native-delivery implementation roadmap, which currently stands at `4/6`.
...
- the native-delivery implementation roadmap now stands at `4/6`, or about `67%`
...
---
*Last updated: 2026-03-28 after shipping v1.36 milestone*
