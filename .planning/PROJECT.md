...
**Goal:** No active milestone. The completed historical greenfield ledger (`18/18`), adapter-only full-conversion roadmap (`6/6`), native-delivery planning roadmap (`8/8`), and the first two implementation slices (`2/6`) now define the current canonical progress baselines.
...
- None. The next follow-on work should continue through the native-delivery implementation roadmap, which currently stands at `2/6`.
...
- the native-delivery implementation roadmap now stands at `1/6`, or about `17%`, with `v1.34` targeting `2/6`, or about `33%`
...
---
*Last updated: 2026-03-28 after starting v1.34 milestone*
