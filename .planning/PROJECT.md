...
## Most Recent Milestone: v1.42 Onboarding Primary LLM Selection

**Result:** Shipped 2026-03-31. OpenRustClaw closed the onboarding primary-model selection roadmap at `4/4`, added provider-specific access-mode selection in CLI onboarding, persisted live verification evidence, introduced explicit primary-model discovery or manual fallback selection, and kept that provider-access-model lane coherent through handoff, resume, repair, and first launch.
