...
- ✓ PPC-04: The `0.1.1` public release was prepared and published with synchronized versioning, release notes, package metadata, crates.io state, and the repo tag `v0.1.1`.
