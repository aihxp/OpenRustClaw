...
Plans:
- [x] **13-01** Add typed mobile operator reports
- [x] **13-02** Surface mobile operator reports in runtime APIs and Control UI
- [x] **13-03** Align mobile parity docs and preserve verification
