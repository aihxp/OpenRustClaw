...
- Most recent shipment: **v1.29 Native Delivery Layer: Runtime Hosts and Background Workers**
...
- Native-delivery roadmap progress: **`5/8` milestones shipped, or about `63%`**
