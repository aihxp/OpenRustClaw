# Requirements Archive: v1.20 Full Greenfield Conversion: Control Plane Route Families II
...
**Status:** Complete in v1.20 Phase 85.
...
**Status:** Complete in v1.20 Phase 86.
...
**Status:** Complete in v1.20 Phase 87.
...
**Status:** Complete in v1.20 Phase 88.
...
|-------------|-------|--------|
| GFC-25 | Phase 85 | Complete |
| GFC-26 | Phase 86 | Complete |
| GFC-27 | Phase 87 | Complete |
| GFC-28 | Phase 88 | Complete |
...
- Last shipped milestone: `v1.20 Full Greenfield Conversion: Control Plane Route Families II`
- Archived requirements: pending archive for `.planning/milestones/v1.20-REQUIREMENTS.md`
- Archived verification bundle: pending archive for `.planning/milestones/v1.20-VERIFICATIONS.md`

## Next Step

Archive `v1.20` and start the next full-conversion milestone with `$gsd-new-milestone`.
