...
The current shipped startup path actively supports WebChat, Telegram, Discord, Slack, WhatsApp, Mattermost, Microsoft Teams, iMessage, Google Chat, Gmail Pub/Sub, Matrix, and Signal. Other channel modules remain in the repo but are gated or deferred from the shipped runtime surface.
