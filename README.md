...
- `openrustclaw orchestrate list|inspect|trace|promote-candidate`
...
- bounded orchestration receipts now also preserve planner/worker/synthesis trace entries and parent/child delegation relationships so operators can inspect execution flow without over-steering the models themselves
