...
<required_reading>
@/home/hprincivil/projects/OpenRustClaw/.codex/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/hprincivil/projects/OpenRustClaw/.codex/get-shit-done/bin/gsd-tools.cjs" init resume)
