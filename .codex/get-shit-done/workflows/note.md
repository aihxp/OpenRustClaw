...
- **Global scope**: `/home/hprincivil/projects/OpenRustClaw/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/hprincivil/projects/OpenRustClaw/.codex/notes/`)
...
2. Glob `/home/hprincivil/projects/OpenRustClaw/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/hprincivil/projects/OpenRustClaw/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/hprincivil/projects/OpenRustClaw/.codex/notes/` — works in any directory
