...
Use template from `/home/hprincivil/projects/OpenRustClaw/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/hprincivil/projects/OpenRustClaw/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/hprincivil/projects/OpenRustClaw/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
