...
| Discord | partial | Auth probe, outbound send, verified Interactions HTTP ingress, Gateway `MESSAGE_CREATE` receive, deferred acknowledgements, and local agent/session routing exist; reconnect/resume coverage remains incomplete |
