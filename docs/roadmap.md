...
- [ ] Add media pipeline parity:
  ...
  - [x] bounded provider-backed image description over shipped Anthropic plus OpenAI-compatible vision lanes,
  - [x] bounded provider-backed document and audio summary lanes over the same shipped Anthropic plus OpenAI-compatible providers,
