...
- [ ] Add media pipeline parity:
  ...
  - [x] bounded provider-backed image text extraction over the same shipped Anthropic, Ollama, plus OpenAI-compatible media lanes,
  - [x] bounded provider-backed image description over shipped Anthropic, Ollama, plus OpenAI-compatible vision lanes,
  - [x] bounded provider-backed document and audio summary lanes over the same shipped Anthropic, Ollama, plus OpenAI-compatible providers,
