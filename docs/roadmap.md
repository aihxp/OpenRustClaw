...
- [ ] Matrix parity.
  - current shipped path covers auth, send, reply/thread relations, polling ingress, inbound reaction events, room actions, helper-driven plus normal-send local file uploads, and inbound media downloads into the Matrix data directory;
