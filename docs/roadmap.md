...
- [ ] Add node pairing/runtime parity:
  ...
  - [x] bounded app-session metrics plus event timelines derived from the same shipped heartbeat/runtime lane,
  ...
  - [x] bounded per-node activity timelines over runtime, notification, inbox, outbox, and command receipts/events,
